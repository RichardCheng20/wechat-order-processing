...
> 详细架构与配置见 [腾讯云上云部署指南.md](./腾讯云上云部署指南.md)
...
- 备案期间可在服务器上部署后端；详见 **[开发联调与生产部署指南](./开发联调与生产部署指南.md)**（SSH 隧道、deploy-prod、本机/远程切换）。
...
- [开发联调与生产部署指南](./开发联调与生产部署指南.md) — SSH 隧道、deploy-prod、本机/远程切换
- [腾讯云上云部署指南（完整版）](./腾讯云上云部署指南.md)
