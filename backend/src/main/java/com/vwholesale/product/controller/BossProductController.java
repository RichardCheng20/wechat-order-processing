...
public class BossProductController {
    ...
    public ApiResponse<ProductVO> saleStatus(@PathVariable Long id, @RequestBody Map<String, String> body) {
        RoleChecker.requireBoss();
        return ApiResponse.ok(productService.updateSaleStatus(id, body.get("saleStatus")));
    }
}
