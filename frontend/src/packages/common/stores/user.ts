...
export type UserRole = 'CUSTOMER' | 'OWNER_ADMIN' | 'STALL_MANAGER' | 'WORKER' | 'PARTNER_ADMIN'
...
export const useUserStore = defineStore('user', {
  ...
  getters: {
    ...
    isBoss: (state) => state.role === 'OWNER_ADMIN' || state.role === 'STALL_MANAGER' || state.role === 'PARTNER_ADMIN',
